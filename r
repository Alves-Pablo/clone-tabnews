...
[1mindex 7a42273..a0f0988 100644[m
[1m--- a/README.md[m
[1m+++ b/README.md[m
[36m@@ -1,2 +1,3 @@[m
 # clone-tabnews[m
[32m+[m
 Um projeto de treinamento na programação[m
[1mdiff --git a/package-lock.json b/package-lock.json[m
[1mindex fca1d36..cc6c046 100644[m
...
[1mindex 21e13dd..e6a4f3f 100644[m
[1m--- a/package.json[m
[1m+++ b/package.json[m
[36m@@ -4,7 +4,9 @@[m
   "description": "Um projeto de treinamento na programação",[m
   "main": "index.js",[m
   "scripts": {[m
[31m-    "dev": "next dev"[m
...
[1mindex 4833962..2a6a70e 100644[m
[1m--- a/pages/index.js[m
[1m+++ b/pages/index.js[m
[36m@@ -1,5 +1,5 @@[m
 function Home() {[m
[31m-    return <h1>Sabrina, como você é gorda meu</h1>[m
[32m+[m[32m  return <h1>Sabrina, como você é gorda meu</h1>;[m
 }[m
 [m
